% This script generates simulation results depicted in Fig. 3, 4, 5 of the
% paper
%
...
Pos_ue = [0 10];           % in meters, user-to-user separation
Distance_ms2bs = 60;       % in meters, user-to-BS distance
AngularSpread_deg = 10;    % in degree, angular spread
...
Bfb_vec = [4:1:12];        % # of bits per user to feedback to BS
Bfb0 = 6;

Bms0 = 80;
Bms_vec = [20:10:120];     % Total # of bits for D2D CSI sharing
